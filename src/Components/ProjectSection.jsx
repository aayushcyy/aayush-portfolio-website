...
function ProjectSection() {
  ...
  return (
    <>
      {/* // Page for Computer Screens */}
      <div
        className="md:min-h-screen h-screen w-full md:flex hidden flex-col items-center bg-[#2d2e70] mt-20 pt-[60px] relative md:mb-[800px]"
        ref={containerRef}
      >
