  ...
  return (
    <div className="w-full md:h-screen h-[66vh] flex flex-col items-start md:py-5 py-8">
      ...
      <div className="flex flex-col w-full md:mt-80 mt-[310px] justify-center relative items-center">
        <div className="bg-[#2B2B2B] w-full md:h-[280px] h-[180px] rounded-t-[30px] absolute -top-48 z-10"></div>
        <h1 className="text-center md:text-[115px] text-[49px] font-[900] md:leading-normal leading-10  uppercase z-50 relative md:-top-0 -top-[68px]">
          Aayush Chaudhary
        </h1>
        <div className="flex w-full items-center md:justify-between justify-center md:-mt-4 -mt-[58px] z-50">
          ...
          <Link className="text-lg font-medium px-5 py-[2px] border-2 rounded-3xl group hover:text-[#FDD6D5] hover:border-[#FDD6D5] hover:scale-105 transition-all duration-300 md:block hidden">
            Get in touch{" "}
